...
import com.bb.vib.extentions.mGetErrorMessage
...
object MyCoroutines {
    ...
    fun <T : Any> hitApi(
        ...
        val handler = CoroutineExceptionHandler { _, exception ->
            com.bb.vib.api.MyCoroutines.onError(exception, mContext, mError)
...
//                hideProgressDialog(mContext)
                ...
                com.bb.vib.api.MyCoroutines.onError(t, mContext, mError)
            }
        }
            ...
            is HttpException -> {
                try {
                    when (throwable.code()) {
                        ...
                        else -> com.bb.vib.api.MyCoroutines.displayError(throwable, mError)
                    }
