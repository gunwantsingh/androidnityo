package com.bb.vib.ui.home.others.smartOtpPin.activeSmartOtp.createSmartOtp
...
import com.bb.vib.databinding.FragmentCreateSmartOtpBinding
...
class CreateSmartOtpFragment : BaseFragment<FragmentCreateSmartOtpBinding>() {

    private val mCreateSmartOtpVM: CreateSmartOtpVM by viewModel()
            ...
            if (s.toString().trim().length == 1) {
                ...
                if (checkInputs()) {
                    ...
                    findNavController().navigate(
                        R.id.action_createSmartOtpFragment_to_confirmSmartOtpFragment,
                        bundle
                    )
                } else {
    ...
    override fun mLayoutRes(): Int {
        return R.layout.fragment_create_smart_otp
    }

    override fun onViewReady() {

        mBinding.createSmartOtpVm = mCreateSmartOtpVM
