package com.bb.vib.ui.home.others.smartOtpPin.changeSmartOtp.confirmChangeNewSmartOtp
...
import com.bb.vib.databinding.FragmentConfirmChangeNewSmartOtpBinding
...
class ConfirmChangeNewSmartOtpFragment : BaseFragment<FragmentConfirmChangeNewSmartOtpBinding>() {
    ...
    private val mConfirmChangeNewSmartOtpVM: ConfirmChangeNewSmartOtpVM by viewModel()
        ...
        override fun afterTextChanged(s: Editable) {
            if (s.toString().trim().length == 1) {
                ...
                if (inputSmartOtp == incomingOtp) {
                    ...
                    successDialog.textSuccessHead?.text = getString(R.string.text_pin_successfully_changed)
                    successDialog.textSuccessMessage?.text = getString(R.string.text_pin_successfully_changed_message)
    ...
    override fun mLayoutRes(): Int {
        return R.layout.fragment_confirm_change_new_smart_otp
    }

    override fun onViewReady() {

        mBinding.confirmChangeNewSmartOtpVm = mConfirmChangeNewSmartOtpVM
