package com.bb.vib.ui.home.others.smartOtpPin.forgotSmartOtp.newSmartOtp
...
class NewSmartOtpFragment : BaseFragment<FragmentNewSmartOtpBinding>() {

    private val mNewSmartOtpVM: NewSmartOtpVM by viewModel()
            ...
            if (s.toString().trim().length == 1) {
                ...
                if (checkInputs()) {
                    ...
                    findNavController().navigate(
                        R.id.action_newSmartOtpFragment_to_confirmNewSmartOtpFragment,
                        bundle
                    )
                } else {
    ...
    override fun mLayoutRes(): Int {
        return R.layout.fragment_new_smart_otp
    }

    override fun onViewReady() {

        mBinding.newSmartOtpVm = mNewSmartOtpVM
